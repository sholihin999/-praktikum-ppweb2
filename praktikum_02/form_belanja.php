...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($produk == 'Televisi'){
            $total_belanja = 4200000 * $jumlah_beli;
        }else if($produk == 'Kulkas'){
            $total_belanja = 3100000 * $jumlah_beli;
        }else if($produk == 'Mesin Cuci'){
            $total_belanja = 3800000 * $jumlah_beli;
        } 
        ...
        echo '<br><strong>Total Belanja : </strong>Rp ' . $total_belanja;
    }
    ?>
